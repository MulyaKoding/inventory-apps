...
const STATS = [
  {
    ...
    icon: (
      <svg viewBox="0 0 48 48" width="24" height="24" fill="none">
        <rect x="8" y="12" width="14" height="18" rx="1.5" stroke="currentColor" strokeWidth="2.5" />
        <rect x="26" y="12" width="14" height="18" rx="1.5" stroke="currentColor" strokeWidth="2.5" />
        <path d="M10 12V8c0-1.1.9-2 2-2h24c1.1 0 2 .9 2 2v4" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" />
        <path d="M18 30v4M30 30v4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      </svg>
    )
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 48 48" width="24" height="24" fill="none">
        <path d="M10 8h28c1.1 0 2 .9 2 2v2H8v-2c0-1.1.9-2 2-2z" stroke="currentColor" strokeWidth="2.5" strokeLinejoin="round" />
        <path d="M8 12h32v20c0 1.1-.9 2-2 2H10c-1.1 0-2-.9-2-2V12z" stroke="currentColor" strokeWidth="2.5" strokeLinejoin="round" />
        <path d="M18 20v6M24 18v8M30 20v6" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" />
      </svg>
    )
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 48 48" width="24" height="24" fill="none">
        ...
        <path d="M24 16v16M20 20h8c1.1 0 2 .9 2 2v4c0 1.1-.9 2-2 2h-8" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    )
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 48 48" width="24" height="24" fill="none">
        <path d="M8 18c-1.1 0-2-.9-2-2v-4c0-1.1.9-2 2-2h32c1.1 0 2 .9 2 2v4c0 1.1-.9 2-2 2H8z" stroke="currentColor" strokeWidth="2.5" strokeLinejoin="round" />
        <path d="M8 30c-1.1 0-2-.9-2-2v-4c0-1.1.9-2 2-2h32c1.1 0 2 .9 2 2v4c0 1.1-.9 2-2 2H8z" stroke="currentColor" strokeWidth="2.5" strokeLinejoin="round" />
        <path d="M8 42c-1.1 0-2-.9-2-2v-4c0-1.1.9-2 2-2h32c1.1 0 2 .9 2 2v4c0 1.1-.9 2-2 2H8z" stroke="currentColor" strokeWidth="2.5" strokeLinejoin="round" />
      </svg>
    )
  }
]
          ...
          <div className="animate-slide-in-left">
            ...
            <div className="flex gap-5 mt-12 flex-wrap">
              {STATS.map((s, i) => (
                <div
                  key={i}
                  className="bg-black/25 backdrop-blur-md border border-white/8 rounded-xl px-5 py-3.5 animate-fade-in flex items-center gap-3"
                ...
                >
                  ...
                  <div>
                    <div className="text-white font-black text-[18px] tracking-tight">
                      {s.value}
                    </div>
                    <div className="text-white/50 text-[10px] font-semibold tracking-wide uppercase mt-0.5">
                      {s.label}
                    </div>
                  </div>
                </div>
